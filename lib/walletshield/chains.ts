...
export const CHAINS: Record<string, ChainConfig> = {
  "1": {
    ...
    fallbackRpcEnv: "ETHEREUM_PUBLIC_RPC_FALLBACK_URL",
  ...
  "56": {
    ...
    nativeSymbol: "BNB",
    rpcEnv: "BSC_RPC_URL",
    fallbackRpcEnv: "BSC_PUBLIC_RPC_FALLBACK_URL",
  ...
  "137": {
    ...
    fallbackRpcEnv: "POLYGON_PUBLIC_RPC_FALLBACK_URL",
  ...
  "42161": {
    ...
    fallbackRpcEnv: "ARBITRUM_PUBLIC_RPC_FALLBACK_URL",
  ...
  "8453": {
    ...
    nativeSymbol: "ETH",
    rpcEnv: "BASE_RPC_URL",
    fallbackRpcEnv: "BASE_PUBLIC_RPC_FALLBACK_URL",
