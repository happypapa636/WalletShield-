...
const COMMANDS: Record<string, string[]> = {
  ...
  inspect: [
    ...
    "Version: Wave 3 Protection Radar",
    "Pipelines: RPC + GoPlus + SoSoValue + SSI + Macro + SoDEX + OpenAI",
    "Revocation: eth_call simulated wallet transaction",
    "Scoring: public weighted formula + source confidence",
    "Status: OPERATIONAL",
  ],
  about: [
    "WalletShield AI",
  ...
  stack: [
    ...
    "Intel:     SoSoValue API + SSI + macro events",
